...
public class PayloadManager {
    ...
    public String createPayloadBookingAsString(){
        ...
        booking.setFirstname("Chiranjeevi");
        booking.setLastname("Muppana");
        booking.setTotalprice(369);
    ...
    public String createPayloadBookingAsStringNegative(){
        Booking booking = new Booking();
    ...
    public String createPayloadBookingFakerJS(){
        ...
        booking.setTotalprice(faker.random().nextInt(100,1000));
    ...
    public String fullUpdatePayloadAsString() {
        ...
        public String partialUpdatePayloadAsString() {
            Booking booking = new Booking();
            booking.setFirstname("Muppana");
            booking.setLastname("Chiranjeevi");
            return gson.toJson(booking);
